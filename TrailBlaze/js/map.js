...
function getDesc(code) {
  if (code === 'BICY') {
	...
	document.getElementById('link').href="../park/index.html?parkCode=BICY";
  }
  else if (code === 'BISC') {
	...
	document.getElementById('link').href="../park/index.html?parkCode=BISC";
  }
  else if (code === 'CANA') {
	...
	document.getElementById('link').href="../park/index.html?parkCode=CANA";
  }
  else if (code === 'CASA') {
	...
	document.getElementById('link').href="../park/index.html?parkCode=CASA";
  }
  else if (code === 'DESO') {
	...
	document.getElementById('link').href="../park/index.html?parkCode=DESO";	
  }
  else if (code === 'DRTO') {
	...
	document.getElementById('link').href="../park/index.html?parkCode=DRTO";
  }
  else if (code === 'EVER') {
	...
	document.getElementById('link').href="../park/index.html?parkCode=EVER";
  }
  else if (code === 'FOMA') {
	...
	document.getElementById('link').href="../park/index.html?parkCode=FOMA";	
  }
  else if (code === 'GUIS') {
	...
	document.getElementById('link').href="../park/index.html?parkCode=GUIS";
  }
  else if (code === 'TIMU') {
	...
	document.getElementById('link').href="../park/index.html?parkCode=TIMU";
  }
  else {
